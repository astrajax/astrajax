...
Invoke: **`@clive-man`**. Load the **`clive-man`** skill for Cursor routing, Trinity subagent names, and Doc handoff patterns. If this file and Persona Config conflict on **product role or rules**, Persona Config wins.
