...
| `SRC-AJ-LAZLO-CRAFT` | `.cursor/skills/lazlo-marlowe-character-craft/SKILL.md`; `hyperagent/builds/build_lazlo_marlowe_v0_1.py`; `agents/registry/hyperagent/astrajax/lazlo-marlowe/build-pack-v0.1.md` | Generated agent pack / skill source | Matthew | Matthew-approved for Lazlo self-spine; pending for founding-cast typings | Current | Lazlo Marlowe craft engine, Vol II distillation, cast typing status |
