...
| `SRC-CLIVE-MAN-AMBIENT` | `.cursor/skills/clive-man-ambient-capture/SKILL.md`; `.cursor/agents/clive-man-ambient-capture.md` | Cursor skill / agent | Matthew | Working current | Current | Ambient Capture 05:00 contract; CREATE_DRAFT_TRUTH; checkpoint sentinel |
