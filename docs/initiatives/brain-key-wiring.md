...
### Draft Brain Truth write contract (17–18 Aug 2026)

Website and HyperAgent capture write Draft Brain Truth by **field IDs**, both
text registers, a live Workshop Brain Registry link, and agent-owned fields only.
Related Projects is optional: **Clive's Man the HEAD** puts `rec…` IDs or none
in the brief; cheap hands copy or write those IDs only. Do not copy Projects or
the builder-review overlay into client brains. Helper:
