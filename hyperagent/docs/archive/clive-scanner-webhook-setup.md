...
> **Retired 2026-06-24.** Clive Context Scanner is no longer production. Clive's Man
> replaced this lane. Wiring scripts moved to `hyperagent/scripts/archive/`. Kept for reference only.
