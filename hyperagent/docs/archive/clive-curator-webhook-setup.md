...
> **Retired 2026-06-24.** Clive Curator is no longer production. Clive's Man replaced
> this lane. Wiring scripts moved to `hyperagent/scripts/archive/`. Kept for reference only.
...
> **Import note (2026-06):** current default is agent JSON only when skills are embedded.
> See `hyperagent/docs/hyperagent-deploy-playbook.md`. Steps below are historical.
