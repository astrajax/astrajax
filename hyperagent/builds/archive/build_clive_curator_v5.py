...
6. Audit script: resolves repo root for Hyperagent (`--repo-root`, `ASTRAJAX_REPO_ROOT`, `/agent/workspace`); fails loud on zero sources; curator target globs include `agents/registry/hyperagent/clive/curator/`.
7. Deprecated launchd plist moved to `hyperagent/schedule/archive/`; Hyperagent schedule is canonical.
8. Live deployment pointer: `agents/registry/hyperagent/clive/curator/LIVE.md`.
...
- [ ] Import `hyperagent/exports/skills/skill-clive-context-curator-v5.json` (see `agents/registry/hyperagent/clive/curator/LIVE.md`).
