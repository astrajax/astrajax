# Doc Brain Base Builder v0.1 — Build Pack
...
**Renamed:** 24 June 2026 — `doc-airtable-builder` → `doc-airtable-minion`; 26 June 2026 — `doc-airtable-minion` → `doc-brain-base-builder`  
**Registry:** `agents/registry/cursor/doc/doc-brain-base-builder/`
...
Primary: `@doc` (Doc routes to Doc Brain Base Builder).
...
- Chapter 1 four-base model **Phase B complete** (25 Jun 2026); IDs in
  ...
  `docs/initiatives/doc-brain-base-builder.md`.
