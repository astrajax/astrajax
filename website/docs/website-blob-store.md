...
| Folio masters | `folio/` |
| Clive plate mattes | `folio/masks/` — teaching: `clive-folio-deckle-v9-4k.png` + `clive-folio-deckle-ink-v9-4k.png` (approved); interaction: `clive-folio-deckle-interaction-v9-4k.png` + `clive-folio-deckle-ink-interaction-v9-4k.png` (wired, taste gate open) |
